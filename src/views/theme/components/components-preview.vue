...
<template>
  <div class="component-preview">
    ...
    <el-row class="demo-line">
      <el-checkbox v-model="checked2" label="Option1" border />
    </el-row>
    <h4>Input</h4>
    ...
    <h4>Cascader</h4>
    <el-row>
      <el-cascader :options="cascadeOptions" v-model="cascaderValue" />
    </el-row>
    <h4>Switch</h4>
    <el-row>
    ...
    <h4>Rate</h4>
    <el-row>
      <el-rate class="demo-line" v-model="rate" />
      <el-rate
        class="demo-line"
        v-model="rate"
        show-score
    ...
    <h4>Tree</h4>
    <el-row style="width: 380px">
      <el-tree :data="treeData" :props="defaultTreeProps" />
    </el-row>
    <h4>Pagination</h4>
    <el-row>
    ...
    <el-row class="demo-line avatar-demo">
      ...
      <el-avatar shape="square" fit="contain" :src="avatarData.url" />
